...
myList = list( "M / Boomer" = M_Boomer, "M / GenX" = M_GenX, "M / Millennial" = M_Millennial, "F / Bommer" = F_Boomer, "F / GenX" = F_GenX, "F / Millennial" = F_Millennial)
...
```{r}
#TO-DO
matrix_test = matrix(1:10)
nn_algorithm_predict(matrix_test, c(1:5), c(1:10))
```
